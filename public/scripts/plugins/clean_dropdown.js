    ...
    jsPsych['survey-dropdown'] = (function(){
        ...
        plugin.trial = function(display_element, block, trial, part) {
            if (trial.element === "item") {
                ...
                var $button_container = $('<div id= "button_container">');
                ...
                display_element.append($button_container);
                $(".dropdown-submit").css({
            ...
            $("#dropdown-submit").click(function() {
                var dropdown_data = {};
                //what exactly does this iterate through?
                $("#jspsych_target").children.each(function () {
                    if ($(this).attr("class") === "main_menu" || $(this).attr("class") === "submenu") {
                        alert($(this).val());
                    }
