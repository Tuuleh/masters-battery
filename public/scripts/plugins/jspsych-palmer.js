...
(function($) {
    jsPsych.palmer = (function() {
        ...
        plugin.trial = function(display_element, block, trial, part) {
            ...
            if (trial.editable) {
                display_element.append($('<button id="jspsych-palmer-submitButton" type="button" class="button">Submit Answer</button>'));
            ...
            function save_data() {
                ...
                if (trial.editable && trial.show_feedback) {
                    ...
                    display_element.append($.parseHTML("<p id='jspsych-palmer-feedback' class='centered'>" + feedback + "</p>"));
